...
yum install -y \
vim nmap iperf iperf3 tmux traceroute git sshpass curl openssh-server tree htop build-essential bash-completion python-pip python-dev build-essential python-setuptools pyth
on-setuptools software-properties-common yum-utils groupinstall development && \
apt clean
